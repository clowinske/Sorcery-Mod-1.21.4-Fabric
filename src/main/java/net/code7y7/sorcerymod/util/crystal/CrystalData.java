...
public enum CrystalData {
    FIRE("fire", true, 0xff9514, 0xff9514, 0xFFAE4C,
            CrystalAbilities.FIRE),

    ELECTRICITY("electricity", true, 0x82F4FF, 0x82F4FF, 0xCEFAFF,
         CrystalAbilities.ELECTRICITY),

    GRAVITY("gravity", true, 0xF070FF, 0xF070FF, 0xF7BCFF,
         CrystalAbilities.GRAVITY),

    MIND("mind", true, 0x00A835, 0x00A835, 0x41D86E,
         CrystalAbilities.FIRE),

    BODY("body", true, 0xA53030, 0xA53030, 0xBF7272,
         CrystalAbilities.FIRE),

    SOUL("soul", true, 0x4F51FF, 0x4F51FF, 0x9B9DFF,
         CrystalAbilities.FIRE),
    ECLIPSE("eclipse", false, 0x001433, 0x001433, 0x0b192e,
         CrystalAbilities.ECLIPSE),
    DISCORD("discord", false, 0x330000, 0x330000, 0x291111,
