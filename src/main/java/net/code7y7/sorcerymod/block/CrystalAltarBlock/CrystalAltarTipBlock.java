...
public class CrystalAltarTipBlock extends Block {
    private static final VoxelShape SHAPE1 = Block.createCuboidShape(0, -32, 0, 16, -20, 16);
    private static final VoxelShape SHAPE2 = Block.createCuboidShape(3, -20, 3, 13, -16, 13);
    private static final VoxelShape SHAPE3 = Block.createCuboidShape(3, -16, 3, 13, 0, 13);
    private static final VoxelShape SHAPE4 = Block.createCuboidShape(3, 0, 3, 13, 9, 13);
    private static final VoxelShape SHAPE = VoxelShapes.union(SHAPE1, SHAPE2, SHAPE3, SHAPE4);

    public static final EnumProperty<Direction> FACING = HorizontalFacingBlock.FACING;

    public CrystalAltarTipBlock(Settings settings){
    ...
    protected ActionResult onUseWithItem(ItemStack stack, BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (!world.isClient() && hand == Hand.MAIN_HAND) {
            CrystalAltarBlockEntity blockEntity = (CrystalAltarBlockEntity) world.getBlockEntity(pos.down(2));
